...
This outlines how to propose a change to cryptoQuotes. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("serkor1/cryptoQuotes", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://serkor1.github.io/cryptoQuotes/CODE_OF_CONDUCT.md). By
